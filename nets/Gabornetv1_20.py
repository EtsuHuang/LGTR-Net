...
class MGaborNet(nn.Module):
    def __init__(self, cfgs, num_classes=1000, width=2.0, dropout=0.2, round_nearest=8):
        ...
        for cfg in self.cfgs:
            ...
            for dk, ksize, exp_size, c_out, scales, se_ratio, stride, tea_id in cfg:
                ...
                scales = _make_divisible(scales * width, 4)
...
def Lgtr_Netv1_20(pretrained=False, progress=True, num_classes=1000):
    model = LGTRNetv1()
